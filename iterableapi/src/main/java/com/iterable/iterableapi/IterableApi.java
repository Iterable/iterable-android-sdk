...
//---------------------------------------------------------------------------------------
    ...
    public static void initialize(@NonNull Context context, @NonNull String apiKey, @Nullable IterableConfig config) {
        ...
        if (sharedInstance.embeddedManager == null) {
            sharedInstance.embeddedManager = new IterableEmbeddedManager(sharedInstance._applicationContext, sharedInstance.config.embeddedMessageAutoFetchInterval, null, null);
        }
